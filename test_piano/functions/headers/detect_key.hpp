...
vector<int> detect_w(Mat &src_rgb, Mat &img, vector<Point> &hand_point,
                     ...
                     const Rect &box, const float &ratio, vector<int> &pre_w,const vector<Rect> &total_top, const vector<Rect> &total_bottom);
void find_box(const Mat &base_img_rgb, vector<double> &white_loc, 
